...
static asn_TYPE_member_t asn_MBR_PGWRecord_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct PGWRecord, servingNodeAddress),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct PGWRecord, accessPointNameNI),
	...
	{ ATF_POINTER, 4, offsetof(struct PGWRecord, pdpPDNType),
	...
	{ ATF_POINTER, 3, offsetof(struct PGWRecord, servedPDPPDNAddress),
	...
	{ ATF_POINTER, 2, offsetof(struct PGWRecord, dynamicAddressFlag),
	...
	{ ATF_POINTER, 1, offsetof(struct PGWRecord, listOfTrafficVolumes),
		(ASN_TAG_CLASS_CONTEXT | (12 << 2)),
		0,
	...
	{ ATF_POINTER, 18, offsetof(struct PGWRecord, chChSelectionMode),
	...
	{ ATF_POINTER, 17, offsetof(struct PGWRecord, iMSsignalingContext),
	...
	{ ATF_POINTER, 14, offsetof(struct PGWRecord, servedIMEISV),
	...
	{ ATF_POINTER, 13, offsetof(struct PGWRecord, rATType),
	...
	{ ATF_POINTER, 12, offsetof(struct PGWRecord, mSTimeZone),
	...
	{ ATF_POINTER, 11, offsetof(struct PGWRecord, userLocationInformation),
	...
	{ ATF_POINTER, 10, offsetof(struct PGWRecord, listOfServiceData),
		(ASN_TAG_CLASS_CONTEXT | (34 << 2)),
		0,
	...
	{ ATF_POINTER, 9, offsetof(struct PGWRecord, servingNodeType),
		(ASN_TAG_CLASS_CONTEXT | (35 << 2)),
		0,
	...
	{ ATF_POINTER, 8, offsetof(struct PGWRecord, p_GWPLMNIdentifier),
	...
	{ ATF_POINTER, 7, offsetof(struct PGWRecord, startTime),
	...
	{ ATF_POINTER, 6, offsetof(struct PGWRecord, stopTime),
	...
	{ ATF_POINTER, 5, offsetof(struct PGWRecord, pDNConnectionID),
	...
	{ ATF_POINTER, 4, offsetof(struct PGWRecord, threeGPP2UserLocationInformation),
	...
	{ ATF_POINTER, 3, offsetof(struct PGWRecord, servedPDPPDNAddressExt),
	...
	{ ATF_POINTER, 2, offsetof(struct PGWRecord, lowPriorityIndicator),
	...
	{ ATF_POINTER, 1, offsetof(struct PGWRecord, uNIPDUCPOnlyFlag),
		(ASN_TAG_CLASS_CONTEXT | (65 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_UNIPDUCPOnlyFlag,
		0,	/* Defer constraints checking to the member type */
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"uNIPDUCPOnlyFlag"
...
static const asn_TYPE_tag2member_t asn_MAP_PGWRecord_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (65 << 2)), 37, 0, 0 } /* uNIPDUCPOnlyFlag */
};
static const uint8_t asn_MAP_PGWRecord_mmap_1[(38 + (8 * sizeof(unsigned int)) - 1) / 8] = {
...
static asn_SET_specifics_t asn_SPC_PGWRecord_specs_1 = {
	...
	38,	/* Count of tags in the CXER map */
