...
static const ber_tlv_tag_t asn_DEF_CAMELInformationPDP_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CAMELInformationPDP_tag2el_1[] = {
...
static const uint8_t asn_MAP_CAMELInformationPDP_mmap_1[(9 + (8 * sizeof(unsigned int)) - 1) / 8] = {
