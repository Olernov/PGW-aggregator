...
static const asn_INTEGER_enum_map_t asn_MAP_DefaultGPRS_Handling_value2enum_1[] = {
	{ 0,	19,	"continueTransaction" },
	{ 1,	18,	"releaseTransaction" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_DefaultGPRS_Handling_enum2value_1[] = {
	0,	/* continueTransaction(0) */
	1	/* releaseTransaction(1) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_DefaultGPRS_Handling_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_DefaultGPRS_Handling_tags_1[] = {
