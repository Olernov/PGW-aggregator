...
static const ber_tlv_tag_t asn_DEF_CAMELInformationMM_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CAMELInformationMM_tag2el_1[] = {
...
static const uint8_t asn_MAP_CAMELInformationMM_mmap_1[(7 + (8 * sizeof(unsigned int)) - 1) / 8] = {
